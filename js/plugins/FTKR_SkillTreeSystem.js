...
(function() {
    ...
    DataManager.stsItemGetSpNotetags = function(group) {
        ...
        var note1j = /<STS SP 获得:[ ]*(\d+)>/i;
        var note2 = /<(?:STS RESET TREE)>/i;
        var note2j = /<STS 全技能树 重置>/i;
        var note3 = /<(?:STS CLEAR TREE)>/i;
        var note3j = /<STS 全技能树 初始化>/i;
...
// ゼフィラプロジェクト用
        this._commandWindow.setHandler('learn skill', this.commandSTS.bind(this));
//
      }
    };

// ゼフィラプロジェクト用
    Scene_Menu.prototype.commandSTS = function() {
        ...
        if (command === 'STS') {
            ...
            switch (true) {
                ...
                case /リセット/i.test(com):
                    ...
                    if (!actor) break;
                    var sp = 0;
                    if (args[2].match(/ALL/i) || args[2].match(/所有/i)) {
