...
(function() {
    ...
    // パラメータの取得と整形
    //=============================================================================
    var paramAlwaysDash           = getParamBoolean(['AlwaysDash', '始终奔跑']);
    var paramCommandRemember      = getParamBoolean(['CommandRemember', '指令记忆']);
    ...
    var paramEraseAlwaysDash      = getParamBoolean(['EraseAlwaysDash', '关闭始终奔跑']);
    var paramEraseCommandRemember = getParamBoolean(['EraseCommandRemember', '取消指令记忆']);
    var paramEraseBgmVolume       = getParamBoolean(['EraseBgmVolume', '去掉BGM音量']);
    var paramEraseBgsVolume       = getParamBoolean(['EraseBgsVolume', '去掉BGS音量']);
    var paramEraseMeVolume        = getParamBoolean(['EraseMeVolume', '去掉ME音量']);
    var paramEraseSeVolume        = getParamBoolean(['EraseSeVolume', '去掉SE音量']);
