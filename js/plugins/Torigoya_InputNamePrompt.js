...
(function (global) {
    ...
    var settings = (function () {
        ...
        return {
            ...
            getMessage: function () {
                return this.message || ($gameSystem && $gameSystem.isJapanese() ? '请输入名字' : 'Please, input name.');
            },
            getMaximumMessage: function () {
                return this.maximumMessage || ($gameSystem && $gameSystem.isJapanese() ? '(名字长度在%1 以内)' : '(%1 characters or less)');
            }
        };
    })();
